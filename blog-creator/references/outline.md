...
5. **Add conversion hooks.**
   Follow `references/conversion.md` to identify natural product mentions and write them to `./blogs/<topic>/conversion-hooks.md`. Then weave them into the outline, marked with `[hook: ...]`.
